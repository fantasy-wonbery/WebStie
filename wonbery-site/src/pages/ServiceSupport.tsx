...
export default function ServiceSupport() {
  ...
  const products = [
    {
      titleKey: 'msp',
      image: 'images/pages/improve-operational-efficiency-header.jpg',
      features: ['7×24小时', '远程支持', '现场服务'],
    },
    {
      titleKey: 'hybrid',
      image: 'images/pages/service17.jpg',
      features: ['私有云', '公有云', '混合部署'],
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-16 bg-dark overflow-hidden">
        <div className="absolute inset-0 opacity-40 bg-cover bg-center md:bg-fixed" style={{ backgroundImage: `url(${B}images/pages/improve-operational-efficiency-header.jpg)` }} />
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                >
                  <h2 className="text-2xl md:text-3xl font-display font-bold text-gray-900 mb-6">
                    {t(`serviceSupport.systems.${product.titleKey}.title`)}
                  </h2>
                  <p className="text-gray-600 leading-relaxed mb-6">
                    {t(`serviceSupport.systems.${product.titleKey}.description`)}
                  </p>
